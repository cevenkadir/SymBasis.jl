...
echo "Done. See $REPO_ROOT/docs/src/benchmarks.md (tables) -- run"
echo "'julia --project=docs docs/make.jl' to render the plots (live @example blocks,"
echo "no image is generated by this script)."
